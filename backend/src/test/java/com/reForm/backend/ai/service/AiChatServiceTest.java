...
class AiChatServiceTest {
    ...
    void rejectsTheTurnWithoutCallingAnythingElseWhenCallerIsNotAWorkspaceMember() {
        AiChatService service = new AiChatService(chatSessionStore, promptBuilder, aiChatClient,
                schemaGenerator, responseParser, blockApplicationService, formSecurity);
